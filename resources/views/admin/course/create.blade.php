    ...
    <div class="row">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="menu_name" id="menu_name">
                    ...
                    @foreach ($menues as $menu)
                        @if ($menu->menu != 'SHOP')
                            <option value="{{$menu->menu}}" <?php echo (old('menu_name') == $menu->menu) ? 'selected' : '' ?> >{{$menu->menu}}</option>
                        @endif
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="sub_menu" id='sub_menu'>
                    ...
                    @foreach ($sub_menues as $sub_menu)
                            <option value="{{$sub_menu}}" <?php echo (old('sub_menu') == $sub_menu) ? 'selected' : '' ?> >{{$sub_menu}}</option>
                    @endforeach
                </select>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8 offset-md-2 offset-xs-2 offset-sm-2">
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ old('included')}}" placeholder="Add comma to add more features" name="included" id="included">
