                    ...
                    <div class="navbar-brand">
                        <a href="index.html" class="logo">
                            ...
                            <span class="logo-text">
                                ...
                                <!-- Light Logo text -->
                                <img src="backend/images/logo-light-text.png" class="light-logo" alt="homepage" />
                            </span>
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="backend/images/users/1.jpg" alt="user" class="rounded-circle" width="31">
                            </a>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets" style="height:430px;">
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    <div class="p-2">
                                        <img src="backend/images/users/1.jpg" alt="user" width="50"
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="backend/images/users/4.jpg" alt="user" width="50"
                                            class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="backend/images/users/5.jpg" alt="user" width="50"
                                            class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                ...
                                <div class="d-flex flex-row comment-row mt-0">
                                    <div class="p-2">
                                        <img src="backend/images/users/2.jpg" alt="user" width="50"
                                            class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
