            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 pb-4 text-center">
                        <h2>Online Live Group Class</h2>
                    </div>
                    <div class="col-md-12 text-center">
                        <h4>3 Days in a Week Group Class & Basic Nutrition </h4>
                    </div>
                </div>
                <div class="row pt-4">
                    <div class="col-md-3 text-center monthly-package">
                        <div class="card" style="width: 15rem;">
                            ...
                            <div class="card-body">
                              ...
                              <ul>
                                <li class="card-text">1 Month- <span>4000 tk</span></li>
                              </ul>
                    ...
                    <div class="col-md-3 text-center pl-4 yearly-package">
                        <div class="card" style="width: 15rem;">
                            ...
                            <div class="card-body">
                              ...
                              <ul>
                                <li class="card-text">3 Month- <span>11000 tk</span></li>
                              </ul>
                              <a href="#" class="btn btn-primary">More Package</a>
                            </div>
                          </div>
                    ...
                    <div class="col-md-3 text-center yearly-package">
                        <div class="card" style="width: 15rem;">
                            ...
                            <div class="card-body">
                              ...
                              <ul>
                                <li class="card-text">6 Month- <span>20000 tk</span></li>
                              </ul>
                              <a href="#" class="btn btn-primary">More Package</a>
                            </div>
                          </div>
                    ...
                    <div class="col-md-3 text-center yearly-package">
                        <div class="card" style="width: 15rem;">
                            ...
                            <div class="card-body">
                              ...
                              <ul>
                                <li class="card-text">1 Year- <span>35000 tk</span></li>
                              </ul>
                              <a href="#" class="btn btn-primary">More Package</a>
                            </div>
                          </div>
